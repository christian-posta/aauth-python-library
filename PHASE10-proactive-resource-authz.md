...
- **Header**: `AAuth-Mission: s256=<hash>`
- **Authentication**: Requires HTTP Message Signature
...
- **Resource Authorization Endpoint**: SPEC_UPDATED.md Section 8 (Resource Token Issuance)
- **AAuth-Mission Header**: SPEC_UPDATED.md Section 7 (Missions)
- **MM Token Endpoint**: SPEC_UPDATED.md Section 10 (Authorization)
- **MM-AS Federation**: Mission Manager federates with Auth Server
