...
This package is self-contained and can be used independently of the AAuth protocol.
It provides:
  - HTTP Message Signatures per RFC 9421
  - Signature-Key header per draft-hardt-httpbis-signature-key
    (schemes: hwk, jwks_uri, jwt)

Typical usage::

    from aauth.signing import sign_request, verify_signature
    from aauth.signing import build_signature_key_header, parse_signature_key
"""
